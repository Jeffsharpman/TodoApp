      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <motion.div variants={fadeInUp} className="flex-1">
          ...
          <p className="text-inksoft text-sm leading-relaxed mb-4">
            ...
            <span className="text-ink font-medium">Oyenuga Joshua</span>, a full
            stack web developer and the founder of{" "}
            ...
            Sharpman specializes in building custom websites, web applications,
            e-commerce solutions, and admin dashboards for businesses and
            individuals.
          </p>
          ...
          <p className="text-inksoft text-sm leading-relaxed mb-5">
            ...
            attention to performance, accessibility, and modern design standards.
          </p>
          ...
          >
            {SERVICES.map((service) => (
              <motion.span
                key={service}
                variants={fadeInUp}
                className="font-mono text-[10px] text-muted border border-line rounded-full px-3 py-1 tracking-wide"
              >
                {service}
              </motion.span>
            ))}
          ...
          <div className="flex flex-wrap gap-3">
            <motion.a
              ...
              className="inline-flex items-center gap-2 bg-primary text-black font-mono text-[10px] font-medium px-5 py-2.5 rounded-lg tracking-widest hover:brightness-110 transition-all"
            >
              <Globe size={14} />
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-line text-muted font-mono text-[10px] px-5 py-2.5 rounded-lg tracking-widest hover:text-primary hover:border-primary transition-colors"
            >
        ...
        {/* Brand card */}
        <motion.div variants={fadeInUp} className="lg:w-[280px] flex-shrink-0">
          <div className="bg-secondary border border-line rounded-xl p-5">
            <div className="mb-4">
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full text-center border border-line text-muted font-mono text-[9px] px-4 py-2 rounded-lg tracking-widest hover:text-primary hover:border-primary transition-colors"
            >
